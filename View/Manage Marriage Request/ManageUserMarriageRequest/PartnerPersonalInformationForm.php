...
<br>
     ...
     <div class="containing">
                ...
                <div class="containing" style="text-align: right; margin-top: 26px;">
  <div class="submitbutton" style="display: flex; justify-content: space-between;">
  <div class="kembalibutton">
    <button type="button" onclick="window.location.href = 'ApplicantPersonalInformationForm.php';" style="margin-bottom: 10px;">Kembali</button>
</div>
    <button type="button" onclick="window.location.href = 'MarriageInformationForm.php';" style="margin-bottom: 10px;">Seterusnya</button>
  </div>
</div>
</div>
                        </table>
