...
<div style="margin-left:25%">
   <div class="container">
        ...
        <div class="containers">
         ...
         <label for="tempatkursus"><b>Tempat Kursus</b></label>
         <input type="text" placeholder=" " name="tempatkursus" id="tempatkursus" required>
  
         <label for="Kursusdate"><b>Tarikh Kursus</b></label>
      ...
      <label for="lulusdate"><b>Tarikh Kelulusan</b></label>
         <input type="date" placeholder=" " name="lulusdate" id="Kursusdate" required>
        </div>
    </div>
<br>
<br>
