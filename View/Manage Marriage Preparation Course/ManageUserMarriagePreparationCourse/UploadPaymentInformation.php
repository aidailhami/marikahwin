...
<div class=sidebar>
    ...
    <ul class="navbar">
        ...
        <li><a href="PersonalInformationForm.php;">Permohonan Berkahwin</a></li>
...
<div style="margin-left:25%">
   <div class="container">
        <div class=page>
                &ensp;Muat Naik maklumat pembayaran
        </div>

        <div class="containers">
  
          <h3>
              Sila muat naik resit pembayaran yang telah selesai:
          </h3>
...
<br>
  ...
  <div class="kembalibutton">
    ...
    <button type="button" onclick="selesai()" style="margin-bottom: 10px;">Hantar</button>
  </div>
</div>
</div>
</body>
...
<script language="">
	function selesai() {
  alert("PERMOHONAN PERKAHWINAN DIHANTAR!");
}
</script>
