...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="navbar">
            ...
            <li class="selected" disabled="true"><a >Pendaftaran Perkahwinan</a></li>
                <ul class="navbar2">
                    <li><a href="index.php?action=staffViewList&userid=<?php echo $staffid?>" >Daftar Kahwin</a></li>
                    <li><a class="selected" href="index.php?action=staffCardList&userid=<?php echo $staffid?>">Kad Kahwin</a></li>
                </ul>
    ...
    <div class="content">
        ...
        <div class="marriagetable">
           ...
           $this->now->staffDisplayTableCard(); 
           ?>
        </div>
    </div>
