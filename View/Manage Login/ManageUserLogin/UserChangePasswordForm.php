...
<div class="container">
<form class="ChangePasswordUserForm" method="POST" action="../index.php">
<i class="fa fa-user" style="font-size:36px" ></i>&nbsp;
<div class="ChangePasswordUser"><img src="../../../asset/shape.png" width="240px" height="80px"><div class="centered"><strong>TUKAR KATA LALUAN </strong></div></div>
        ...
        <input type="text" id="UserCurrentPassword" name="UserCurrentPassword"><br><br>
        <label>Kata Laluan Baru</label><a>: &nbsp;</a>
        <input type="text" id="UserNewPassword" name="UserNewPassword"><br><br>
        <label>Ulangan Kata Laluan Baru</label><a>: &nbsp;</a>
        <input type="text" id="UserConfirmNewPassword" name="UserConfirmNewPassword"><br><br><br>
  <button type="submit">Tukar Kata Laluan</button> <br>
