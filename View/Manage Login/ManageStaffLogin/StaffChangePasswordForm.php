...
<div class="container">
<form class="ChangePasswordStaffForm" method="POST" action="../BusinessServices/Controller/StaffController.php">
    <div class="FormHeader"><img class="imgicon" src="../../../asset/AdminStaffIcon.png" width="100px" height="100px">&nbsp;  &nbsp;<strong>TUKAR KATA LALUAN</strong></div>
        ...
        <input type="text" id="StaffCurrentPassword" name="StaffCurrentPassword"><br><br>
        <label>Kata Laluan Baru</label><a>: &nbsp;</a>
        <input type="text" id="StaffNewPassword" name="StaffNewPassword"><br><br>
        <label>Ulangan Kata Laluan Baru</label><a>: &nbsp;</a>
        <input type="text" id="StaffConfirmNewPassword" name="StaffConfirmNewPassword"><br><br>
