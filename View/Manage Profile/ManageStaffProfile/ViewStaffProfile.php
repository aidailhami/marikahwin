   ...
   <div class="container2">
        <table>
         ...
         <tr>
                ...
                <td>1.</td><td><?php echo $row['StaffIC']; ?></td> <td> <?php echo $row['StaffName']; ?> </td> <td><?php echo $row['StaffCategoryAccess']; ?> </td> <td> <a href="../../App/ManageStaffProfileAdminView/EditStaffProfile.php"> <i class='far fa-edit' style='font-size:24px'></i></a>  <a href="../../App/ManageStaffProfileAdminView/DeleteStaffProfile.php"><i class='fas fa-eraser' style='font-size:24px; color:red'></i></a> &nbsp;<a href="../../App/ManageStaffProfileAdminView/OpenPasswordRestriction.php"><i class='fas fa-user-plus' style='font-size:24px'></i></a> </td>
                </tr>
                </table>
