    ...
    <div class="content">
        ...
        <form class="UserProfileView" method="POST" action="../.php">
                 ...
                 <br>
                    ...
                    <input type="text" id="UserName" name="UserName" required>&nbsp;&nbsp;<i class='fas fa-pencil-alt' style='font-size:24px;color:grey'></i>
                  <br>
                  ...
                  <br>
                    ...
                    <input type="text" class id="UserPhoneNumber"required name="UserPhoneNumber">&nbsp;&nbsp;<i class='fas fa-pencil-alt' style='font-size:24px;color:grey'></i>
                    <br>
