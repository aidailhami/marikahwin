...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class=page>
                &ensp;<a href="StaffMainConsultationPage.php" class=pagelink>Aduan / Khidmat Nasihat</a> >> Kelulusan Permohonan
            </div>
            <div class=box style="margin-top:40px; padding:10px">
                <table style="margin-top:20px;border:1px solid black;text-align:left;width:100%;height:100%;padding:10px;">
                    <caption style="border:1px solid black;text-align: center;background-color: #bbe1fe;padding:5px;">KELULUSAN PERMOHONAN</caption>
                    <tr>
                    ...
                    <tr>
                        <td>Status Permohonan<span class="bold red">*</span></td>
                        <td> : </td>
                        <td>
                ...
                <div style="margin-left:670px;margin-top:20px;text-decoration:none;">
