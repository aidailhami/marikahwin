<?php
    ...
    require('../../Business/Controller/StaffConsultationController.php');
?>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class=page>
                &ensp;<a href="StaffMainConsultationPage.php" class=pagelink>Aduan / Khidmat Nasihat</a> >> Permohonan Baru
            </div>
            <div class=msg>
                <br><br>
            ...
            <div class=box>
                <form name=consult class=consult_form2 method="post" onchange=purpose()>
