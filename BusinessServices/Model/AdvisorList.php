...
INNER JOIN spouse_details ON user.UserID=spouse_details.UserID
INNER JOIN marriage_consultation ON user.UserID=marriage_consultation.UserID 
INNER JOIN consultation_session ON user.UserID=consultation_session.UserID
INNER JOIN advisor ON advisor.Advisor_ID=consultation_session.Advisor_ID
INNER JOIN wali_details ON user.UserID=wali_details.UserID 
